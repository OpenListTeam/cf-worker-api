...
!((t, e) => {
  ...
  const U = {
    ...
    V = {
      ...
      parents(t, e) {
        const i = [];
        let n = t.parentNode;
        while (n && n.nodeType === Node.ELEMENT_NODE && 3 !== n.nodeType) n.matches(e) && i.push(n), (n = n.parentNode);
        return i;
      },
      prev(t, e) {
  ...
  var mt = "top",
    ...
    Ot = "popper",
    Ct = "reference",
    kt = yt.reduce((t, e) => t.concat([e + "-" + wt, e + "-" + Et]), []),
    Lt = [].concat(yt, [vt]).reduce((t, e) => t.concat([e, e + "-" + wt, e + "-" + Et]), []),
    xt = "beforeRead",
    Dt = "read",
    St = "afterRead",
    Nt = "beforeMain",
      ...
      return (
        ...
        () => {
          Object.keys(e.elements).forEach((t) => {
            var n = e.elements[t],
              s = e.attributes[t] || {},
              o = Object.keys(e.styles.hasOwnProperty(t) ? e.styles[t] : i[t]).reduce((t, e) => ((t[e] = ""), t), {});
            zt(n) &&
              Rt(n) &&
  ...
  function ge(t) {
    return t.replace(/left|right|bottom|top/g, (t) => me[t]);
  }
  var _e = { start: "end", end: "start" };
  function be(t) {
    return t.replace(/start|end/g, (t) => _e[t]);
  }
  function ve(t) {
    var e = Wt(t);
        ...
        var n =
            "clippingParents" === e
              ? ((t) => {
                  ...
                  return $t(i) ? e.filter((t) => $t(t) && Xt(t, i) && "body" !== Rt(t)) : [];
                })(t)
              : [].concat(e),
          s = [].concat(n, [i]),
          o = s[0],
  ...
  function Le(t, e) {
    ...
    var i = e,
      ...
      c = void 0 === l ? Lt : l,
      h = ce(n),
      d = h ? (a ? kt : kt.filter((t) => ce(t) === h)) : yt,
      u = d.filter((t) => c.indexOf(t) >= 0);
    0 === u.length && (u = d);
    var f = u.reduce(
      (e, i) => ((e[i] = ke(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[Ut(i)]), e),
      {}
    );
    ...
    fn: (t) => {
      ...
      if (!e.modifiersData[n]._skip) {
        for (
          ...
          var I = ge(N),
            P = [];
          if ((o && P.push(S[k] <= 0), a && P.push(S[N] <= 0, S[I] <= 0), P.every((t) => t))) {
            (T = C), (A = !1);
            break;
          }
          E.set(C, P);
  ...
  function Se(t) {
    return [mt, _t, gt, bt].some((e) => t[e] >= 0);
  }
  const Ne = {
      name: "hide",
      enabled: !0,
        ...
        h = {
          ...
          setOptions: (i) => {
            ...
            var r,
              ...
              u = ((t) => {
                var e = He(t);
                return Bt.reduce((t, i) => t.concat(e.filter((t) => t.phase === i)), []);
              })(
